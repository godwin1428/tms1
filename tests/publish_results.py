...
def main():
    ...
    e2e_path = os.path.join(root_dir, "E2E_Test_Report_TMS_20260613_101008.xlsx")
    sec_path = os.path.join(root_dir, "Vulnerability Test Results", "Vulnerability_Report_Post_Remediation.xlsx")
