...
const PatientPortal = (() => {
    ...
    return `<div class="view" id="pat-book">
      ...
      <div class="grid-2" style="margin-bottom:var(--space-6)">
        ...
        <div class="card"><div class="card-header"><h3>Select Slot</h3></div><div class="card-body">
          ...
          <button class="btn btn-primary btn-lg w-full" id="confirm-book-btn" disabled><i class="fa-solid fa-check"></i> Book Now</button>
        </div></div>
      </div>
    </div>`;
  }
  ...
  async function confirmBooking() {
    ...
    btn.disabled = false;
    btn.innerHTML = '<i class="fa-solid fa-check"></i> Book Now';
  }
